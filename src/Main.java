...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        user2.adicionaLivro(new Livro("Book4", "Author4", "Publisher4", 2004, 4));
        user2.adicionaLivro(new Livro("Book5", "Author5", "Publisher5", 2005, 5));
        Usuario user = ur.getUsuario("jhoan.log", "123");
        user.adicionaLivro(new Livro("Book1", "Author1", "Publisher1", 2001, 1));
        user.adicionaLivro(new Livro("Book2", "Author2", "Publisher2", 2002, 2));
        user.adicionaLivro(new Livro("Book3", "Author3", "Publisher3", 2003, 3));
        BibliotecaRepo bGeral = BibliotecaRepo.getInstance();
        bGeral.getBiblioteca().adicionarLivro(new Livro("Book4", "Author4", "Publisher4", 2004, 4));
        bGeral.getBiblioteca().adicionarLivro(new Livro("Book5", "Author5", "Publisher5", 2005, 5));
        bGeral.getBiblioteca().adicionarLivro(new Livro("Book1", "Author1", "Publisher1", 2001, 1));
        bGeral.getBiblioteca().adicionarLivro(new Livro("Book2", "Author2", "Publisher2", 2002, 2));
        bGeral.getBiblioteca().adicionarLivro(new Livro("Book3", "Author3", "Publisher3", 2003, 3));
